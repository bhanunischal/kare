...
export function DaycareSettingsDialog({ 
    daycare, 
    adminUser, 
    isOpen, 
    onOpenChange 
    ...
    const [detailsState, detailsFormAction, isDetailsPending] = useActionState(updateDaycareDetails, updateDetailsInitialState);
    const [passwordState, passwordFormAction, isPasswordPending] = useActionState(resetDaycareAdminPassword, resetPasswordInitialState);
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Manage Daycare: {daycare.name}</DialogTitle>
                    <DialogDescription>
                        Edit details, manage the admin user, and view subscription information.
                    </DialogDescription>
                </DialogHeader>
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start py-4 max-h-[80vh] overflow-y-auto pr-4">

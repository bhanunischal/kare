                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                    <div className="space-y-2">
                     ...
                     <div className="space-y-2">
                      ...
                      <Input id="mother-email" name="mother-email" type="email" placeholder="e.g., mary@example.com" />
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="father-email" name="father-email" type="email" placeholder="e.g., john@example.com" />
                    </div>
                    <div className="space-y-2">
              ...
              {isEditing && editedData ? (
                <form action={updateFormAction} className="space-y-6 py-4 max-h-[60vh] overflow-y-auto pr-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                       ...
                       <div className="space-y-2">
                        ...
                        <Select name="gender" value={editedData.gender || ''} onValueChange={(value) => handleSelectChange('gender', value)}>
                      ...
                      <div className="space-y-2">
                        ...
                        <Select name="program" value={editedData.program} onValueChange={(value) => handleSelectChange('program', value)}>
                            <SelectTrigger id="edit-program"><SelectValue/></SelectTrigger>
                      ...
                      <div className="space-y-2">
                          ...
                          <Select name="programType" value={editedData.programType} onValueChange={(value) => handleSelectChange('programType', value)}>
                              <SelectTrigger id="edit-programType"><SelectValue/></SelectTrigger>
                              <SelectContent>{programTypeOptions.map(option => <SelectItem key={option} value={option}>{option}</SelectItem>)}</SelectContent>
                          </Select>
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="edit-motherEmail">Mother's Email</Label>
                        <Input id="edit-motherEmail" name="motherEmail" value={editedData.motherEmail || ''} onChange={handleEditChange} />
                      </div>
                      <div className="space-y-2">
                       ...
                       <div className="space-y-2">
                        <Label htmlFor="edit-fatherEmail">Father's Email</Label>
                        <Input id="edit-fatherEmail" name="fatherEmail" value={editedData.fatherEmail || ''} onChange={handleEditChange} />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="edit-homePhone">Home Phone</Label>
                        <Input id="edit-homePhone" name="homePhone" value={editedData.homePhone || ''} onChange={handleEditChange} />
                      </div>
                      <div className="space-y-2">
                  ...
                  <div className="space-y-6 py-4 text-sm max-h-[60vh] overflow-y-auto pr-4">
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-y-4">
                        ...
                        <div>
                         ...
                         <div>
                            ...
                            <dd className="mt-1 text-foreground">{selectedChild.gender || 'N/A'}</dd>
                        </div>
                        <div>
                        ...
                        <div>
                         ...
                         <div>
                            ...
                            <dd className="mt-1 text-foreground">
                                <Badge 
                                    variant={selectedChild.status === 'Active' ? 'default' : selectedChild.status === 'Waitlisted' ? 'secondary' : 'outline'} 
                      ...
                      <div>
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4">
                               ...
                               <div>
                                  <dt className="font-medium text-muted-foreground">Mother's Email</dt>
                                  <dd className="mt-1 text-foreground">{selectedChild.motherEmail || 'N/A'}</dd>
                              </div>
                              <div>
                              ...
                              <div>
                                  <dt className="font-medium text-muted-foreground">Father's Email</dt>
                                  <dd className="mt-1 text-foreground">{selectedChild.fatherEmail || 'N/A'}</dd>
                              </div>
                               <div>
                                  <dt className="font-medium text-muted-foreground">Home Phone</dt>
                                  <dd className="mt-1 text-foreground">{selectedChild.homePhone || 'N/A'}</dd>
                              </div>
                              <div>

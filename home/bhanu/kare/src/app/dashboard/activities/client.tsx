...
import { Plus, Edit, Trash2, Sparkles, BookOpen, Music, Paintbrush, Leaf, Microscope, ChevronLeft, ChevronRight, Loader2 } from "lucide-react";
...
const createInitialState = { message: null, errors: null };

function SaveActivityButton() {
...
export default function ActivitiesClient({ initialActivities }: { initialActivities: Activity[] }) {
  ...
  const [createState, createFormAction] = useActionState(createActivity, createInitialState);
  const [updateState, updateFormAction] = useActionState(updateActivity, createInitialState);
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="sm:max-w-2xl">
            <form action={editingActivity ? updateFormAction : createFormAction}>
              {editingActivity && <input type="hidden" name="id" value={editingActivity.id} />}
              <DialogHeader>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                          ...
                          <Input id="date" name="date" type="date" defaultValue={editingActivity?.date || format(currentDate, 'yyyy-MM-dd')} required />
                      </div>
                       <div className="space-y-2">
